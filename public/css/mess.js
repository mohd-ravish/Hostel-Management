$(".sat").click(function(){
     ...
     $(".heading").text("Minimum expected menu on Saturday");
...
$(".sun").click(function(){
     ...
     $(".thu").removeClass("thu-size");
     $(".fri").removeClass("fri-size");
     $(".heading").text("Minimum expected menu on Sunday");
...
$(".mon").click(function(){
     ...
     $(".thu").removeClass("thu-size");
     $(".fri").removeClass("fri-size");
     $(".heading").text("Minimum expected menu on Monday");
...
$(".tue").click(function(){
     ...
     $(".thu").removeClass("thu-size");
     $(".fri").removeClass("fri-size");
     $(".heading").text("Minimum expected menu on Tuesday");
...
$(".wed").click(function(){
     ...
     $(".thu").removeClass("thu-size");
     $(".fri").removeClass("fri-size");
     $(".heading").text("Minimum expected menu on Wednesday");
...
$(".thu").click(function(){
     ...
     $(".wed").removeClass("wed-size");
     $(".fri").removeClass("fri-size");
     $(".heading").text("Minimum expected menu on Thursday");
...
$(".fri").click(function(){
     ...
     $(".wed").removeClass("wed-size");
     $(".thu").removeClass("thu-size");
     $(".heading").text("Minimum expected menu on Friday");
